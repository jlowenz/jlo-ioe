/*
 * $Id: MultiSplitLayout.java,v 1.3 2007/03/16 21:38:05 rbair Exp $
 *
 ...
 * the default layout manager for MSP.  MSP
...
public class MSPLayout implements LayoutManager {
    ...
    /**
     * Create a MSPLayout with a default model with a single
    ...
    /**
     * Create a MSPLayout with the specified model.
     *
     * #see setModel
     */
    public MSPLayout(Node model) {
	this.model = model;
    ...
    /**
     * Add a component to this MSPLayout.  The
    ...
    /**
     * Base class for the nodes that model a MSPLayout.
     */
	...
	public String toString() {
	    ...
	    StringBuffer sb = new StringBuffer("MSPLayout.Split");
	...
	public String toString() {
	    StringBuffer sb = new StringBuffer("MSPLayout.Leaf");
	    sb.append(" \"");
	    sb.append(getName());
	    sb.append("\"");
	    sb.append(" weight=");
	...
	public String toString() {
	    return "MSPLayout.Divider " + getBounds().toString();
	}
    }


    private static void throwParseException(StreamTokenizer st, String msg) throws Exception {
	throw new Exception("MSPLayout.parseModel Error: " + msg);
    }
     ...
     * MSPLayout model (a tree of Nodes) using a
